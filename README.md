...
context menus, and a Playwright/Electron test suite for the core map workflows.
...
| **E2E Tests** | Playwright/Electron covers import, persistence, tools, player window, and asset protection |
...
changes, player window sync, blackout, player viewport, and asset traversal
protection.
